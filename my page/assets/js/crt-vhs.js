...
const vfx = new VFX({ 
  scrollPadding: false,
  postEffect: { shader },
  autoResize: true // esto hace que el canvas se ajuste al tamaño de la ventana
});

// Ajuste para móviles
function adjustCanvas() {
  const ratio = window.devicePixelRatio || 1;
  vfx.canvas.width = window.innerWidth * ratio;
  vfx.canvas.height = window.innerHeight * ratio;
